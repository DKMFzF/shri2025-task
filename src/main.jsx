    ...
    return <main className="main">
        ...
        <section className="section main__devices">
            <div className="section__title">
                ...
                <select className="section__select" style={{ backgroundImage: 'url(./arrow-down.svg)' }} defaultValue="all" onInput={onSelectInput}>
                    {TABS_KEYS.map(key =>
            ...
            <div className="section__panel-wrapper" ref={ref}>
                ...
                {hasRightScroll &&
                    <div className="section__arrow" style={{ backgroundImage: 'url(./arrow-left.png)' }} onClick={onArrowCLick}></div>
                }
            </div>
        </section>
    </main>;
